        ...
        try {
            ...
            switch (leaf.filter) {
                ...
                case FilterType.NameExact:
                    return oracleNode({
                        filtersUsed: ["exact"],
                        filterFunc: matchTextExact("name", leaf.value)
                    });
                ...
                case FilterType.Oracle:
                    return oracleNode({
                        filtersUsed: ["oracle"],
                        filterFunc: matchTextNoReminder('oracle_text', leaf.value),
                    })
                ...
                case FilterType.FullOracle:
                    return oracleNode({
                        ...
                        filterFunc: matchText('oracle_text', leaf.value),
                    })
                ...
                case FilterType.Type:
                    return oracleNode({
                        filtersUsed: ["type"],
                        filterFunc: matchText('type_line', leaf.value),
                    })
                ...
                case FilterType.Date: {
                    ...
                    if (isNaN(valueDate.getTime())) {
                        ...
                        try {
                            ...
                            return Promise.reject({
                                ...e,
                                message: `${leaf.value} must fit date format yyyy or yyyy-MM-dd`,
                                errorOffset: leaf.offset
                            })
                        }
                    }
                ...
                case FilterType.Lore:
                    const hasName = matchText("name", leaf.value)
                    const hasType = matchText("type_line", leaf.value)
                    const hasText = matchTextNoReminder("oracle_text", leaf.value)
